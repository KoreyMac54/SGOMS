...
class Bottom_Up_Communication_Module(ccm.ProductionSystem):
    ...
    def call_out_goal(visual_buffer='goal:visible'):
        if callOutMade == True:
            pass#print 'call out already made, not making it again'
            pass
        elif callOutMade == False:
            pass#print 'goal has been spotted: communicating planning unit to teammates'
...
##class attributes: buffers, modules, variables   
    ...
    #need a global reference to goal square for delta calc
